...
import dex_events from "https://deno.land/std@0.224.0/node/events.ts";
export const events = dex_events;

import dex_util from "https://deno.land/std@0.224.0/node/util.ts";
...
import dex_assert from "https://deno.land/std@0.224.0/node/assert.ts";
export const assert = dex_assert;

import dex_url from "https://deno.land/std@0.224.0/node/url.ts";
...
import dex_stream from "https://deno.land/std@0.224.0/node/stream.ts";
